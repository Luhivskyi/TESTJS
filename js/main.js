...
function ClientDetailsOnSuccess(n) {
  n.success === !0
    ...
    : (LoaderOff(), $(".reg-btn").prop("disabled", !1));
}
...
(function (n) {
  ...
  (function (n) {
    function r(i) {
      0 < i.clientY ||
        (t && clearTimeout(t),
        0 >= n.exitIntent.settings.sensitivity
    ...
    n.exitIntent = function (t, u) {
      if (
        ((n.exitIntent.settings = n.extend(n.exitIntent.settings, u)),
        "enable" == t)
      )
        n(window).mouseleave(r), n(window).mouseenter(i);
      else if ("disable" == t)
        i(),
          n(window).unbind("mouseleave", r),
          n(window).unbind("mouseenter", i);
      else
...
$(function () {
    ...
    if (c == 0)
      for (e = 0; e < r; e++)
        (f = i(u)),
          (o = f[0]),
          (s = f[1]),
          $(".done_block__reviews_items .review").append(o),
          (u[e] = s);
    else
      (h = n(0, c)),
        (f = i(u)),
        (o = f[0]),
        (s = f[1]),
        ($(".done_block__reviews_items .review")[h].outerHTML = $(o).html()),
        (u[h] = s);
    l = n(3, 8) * 1e3;
  ...
  function i(t) {
    ...
    return (
      (u = n(100, 600)),
      (f =
        '<li class="review__item"><div class="review__user_photo"><img src="img/users/' +
        i +
        '.jpg" alt=""></div><div class="review__info"><div class="review__info_name">' +
        names[i] +
        '</div><div class="review__info_signature">только что заработал(а)</div><div class="review__info_money">$ ' +
        u +
        "," +
        n(10, 99) +
        "</div></div></li>"),
    ...
    f = (function () {
      ...
      return (
          ...
          return (
            ...
            null != document.createEvent
              ? ((u = document.createEvent("CustomEvent")),
                u.initCustomEvent(n, t, i, r))
              : null != document.createEventObject
              ? ((u = document.createEventObject()), (u.eventType = n))
              : (u.eventName = n),
            u
          );
        }),
        (n.prototype.emitEvent = function (n, t) {
          return null != n.dispatchEvent
            ? n.dispatchEvent(t)
            : t in (null != n)
            ? n[t]()
            : "on" + t in (null != n)
        ...
        (n.prototype.addEvent = function (n, t, i) {
          return null != n.addEventListener
        ...
        (n.prototype.removeEvent = function (n, t, i) {
          return null != n.removeEventListener
      ...
      return (
            ...
            (u = t[i]),
              ...
              r.push(
                function () {
                  var t, o, r, e;
                  for (
                    r = this.vendors, e = [], t = 0, o = r.length;
                    o > t;
                    t++
                  )
                    (f = r[t]),
                      e.push(
                        (n["" + f + i.charAt(0).toUpperCase() + i.substr(1)] =
                          u)
                      );
                  return e;
                }.call(this)
        ...
        (u.prototype.vendorCSS = function (n, t) {
          ...
          for (
            ...
            (s = f[i]), (u = u || e.getPropertyCSSValue("-" + s + "-" + t));
          return u;
        }),
        ...
        (u.prototype.isVisible = function (n) {
          var r, u, t, f, i;
          return (
            (u = n.getAttribute("data-wow-offset") || this.config.offset),
            (i =
